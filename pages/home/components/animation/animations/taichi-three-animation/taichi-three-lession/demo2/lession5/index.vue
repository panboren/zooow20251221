...
animateFrame()</pre>
      ...
      <div class="demo-section">
        <h2>🖥️ 当前演示：第五课 - 动画效果</h2>
        <p class="description">
          使用 requestAnimationFrame 实现动画：呼吸的彩虹圆
        </p>
        ...
        <div class="button-group">
          ...
          <button class="btn btn-secondary" @click="nextLesson" :disabled="currentLesson === 4">
            下一课 →
          </button>
        </div>
