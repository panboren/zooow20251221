      ...
      <div class="control-panel">
        ...
        <div class="control-group">
          ...
          <div class="control-buttons">
            ...
            <button :class="['action-button', { active: showCompare }]" @click="showCompare = !showCompare">
...
const presets = ref<Array<{ name: string; modes: number[]; intensity: number }>>([]) // 预设列表
  ...
  renderKernel = ti.kernel(function render(time: any) {
    ...
    for (let f of ti.inputFragments()) {
      ...
      if (mode26 === 1 && !isCompareMode) {
        ...
        let layer1: f32 = blurRadius * 1.0 / IMAGE_SIZE
        let layer2: f32 = blurRadius * 2.0 / IMAGE_SIZE
        let layer3: f32 = blurRadius * 3.0 / IMAGE_SIZE
